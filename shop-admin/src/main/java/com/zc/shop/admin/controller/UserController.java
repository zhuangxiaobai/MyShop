...
import com.zc.shop.admin.dto.UsersLoginParam;
...
public class UserController {
    ...
    @ResponseBody
    public CommonResult<Users> register(@RequestBody UsersParam usersParam) {
    ...
    @ResponseBody
    public CommonResult login(@RequestBody UsersLoginParam usersLoginParam ) {
